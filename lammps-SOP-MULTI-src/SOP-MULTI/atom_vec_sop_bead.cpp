...
AtomVecSop_bead::AtomVecSop_bead(LAMMPS *lmp) : AtomVec(lmp)
{
  molecular = Atom::MOLECULAR;
  bonds_allow = angles_allow = dihedrals_allow = impropers_allow = 1;
  mass_type = PER_TYPE;

  atom->molecule_flag = atom->domain_id_flag = atom->residue_id_flag = atom->q_flag = 1;
  ...
  // clang-format off
  fields_grow = {"q", "molecule", "domain_id" , "residue_id", "num_bond", "bond_type", "bond_atom", "num_angle", "angle_type",
  ...
  fields_copy = {"q", "molecule", "domain_id" , "residue_id", "num_bond", "bond_type", "bond_atom", "num_angle", "angle_type",
    "angle_atom1", "angle_atom2", "angle_atom3", "num_dihedral", "dihedral_type", "dihedral_atom1",
    "dihedral_atom2", "dihedral_atom3", "dihedral_atom4", "num_improper", "improper_type",
    "improper_atom1", "improper_atom2", "improper_atom3", "improper_atom4", "nspecial", "special"};
  fields_border = {"q", "molecule" ,"domain_id" , "residue_id"};
  fields_border_vel = {"q", "molecule", "domain_id" , "residue_id"};
  fields_exchange = {"q", "molecule", "domain_id" , "residue_id", "num_bond", "bond_type", "bond_atom",
 ...
 fields_restart = {"q", "molecule",  "domain_id" , "residue_id","num_bond", "bond_type", "bond_atom", "num_angle",
  ...
  fields_create = {"q", "molecule",  "domain_id" , "residue_id", "num_bond", "num_angle",
    "num_dihedral", "num_improper", "nspecial"};
  fields_data_atom = {"id", "molecule", "domain_id" , "residue_id", "type", "q", "x"};
...
AtomVecSop_bead::~AtomVecSop_bead()
{
...
void AtomVecSop_bead::grow_pointers()
{
...
void AtomVecSop_bead::pack_restart_pre(int ilocal)
{
...
void AtomVecSop_bead::pack_restart_post(int ilocal)
{
...
void AtomVecSop_bead::unpack_restart_init(int ilocal)
{
  nspecial[ilocal][0] = 0;
  nspecial[ilocal][1] = 0;
  nspecial[ilocal][2] = 0;
...
void AtomVecSop_bead::data_atom_post(int ilocal)
{
  num_bond[ilocal] = 0;
  num_angle[ilocal] = 0;
