...
BondFENE_SOP_OMP::BondFENE_SOP_OMP(class LAMMPS *lmp)
  : BondFENE_SOP(lmp), ThrOMP(lmp,THR_BOND)
{
...
void BondFENE_SOP_OMP::compute(int eflag, int vflag)
{
  ev_init(eflag,vflag);
...
void BondFENE_SOP_OMP::eval(int nfrom, int nto, ThrData * const thr)
{
  int i1,i2,n,type;
