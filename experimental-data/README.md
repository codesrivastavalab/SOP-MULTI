...
In cases where the data was unavailable, we extracted the datapoints from the original article using the WebPlotDigitizer.

Ref: [https://automeris.io](https://automeris.io) <br/>
...
[Data](https://sassie-web.chem.utk.edu/docs/sassie-web-quick-start/files/sans_data.sub)
...
[Data](https://github.com/KULL-Centre/papers/tree/main/2020/hnRNPA1-martin-et-al/hnRNPA1/SAXS)
